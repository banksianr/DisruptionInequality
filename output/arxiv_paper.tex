...
The analysis pipeline is implemented in Python and uses the OpenAlex API \citep{priem2022} for bibliometric data and the \citet{park2023} Zenodo dataset (Record 7258379) for population benchmarking. All analysis code and cached API responses are available from the corresponding author upon request.
